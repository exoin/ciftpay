...
| verified_at | timestamptz | set after KES 1 STK control check |
| verification_checkout_id | text | Daraja `CheckoutRequestID` of the control STK |
| c2b_urls_registered_at | timestamptz | RegisterURL done |
